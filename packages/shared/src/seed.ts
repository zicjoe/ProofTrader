...
const attributionByMode: ProofTraderSnapshot["dashboard"]["attributionByMode"] = {
  spot: {
    mode: "spot",
...
export const seedSnapshot: ProofTraderSnapshot = {
  ...
  strategy: {
    ...
    ai: {
      ...
      portfolioAllocation: {
        ...
        targetAccountMode: "spot",
        targetBucket: "majors",
        targetSide: "LONG",
        summary: "Portfolio allocation is clear enough for a normal spot ticket, but the engine is still watching mode and bucket crowding before each new entry.",
        reasons: ["Spot book remains diversified enough for normal sizing."],
        recommendedSizeMultiplier: 0.94,
        effectiveTradeSizeUsd: 705,
        leverageCap: 1,
        modeExposureUtilization: 0.53,
        bucketExposureUtilization: 0.31,
        sideExposureUtilization: 0.44,
        portfolioHeat: 0.46,
        openPositionsInMode: 3,
        openPositionsInBucket: 2,
        appliedAt: null
      }
    }
  },
